...
public final class FileServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.zyc.protocol.User,
      com.zyc.protocol.FileOuterClass.File> getGetFileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getFile",
      requestType = com.zyc.protocol.User.class,
      responseType = com.zyc.protocol.FileOuterClass.File.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.zyc.protocol.User,
      com.zyc.protocol.FileOuterClass.File> getGetFileMethod() {
    io.grpc.MethodDescriptor<com.zyc.protocol.User, com.zyc.protocol.FileOuterClass.File> getGetFileMethod;
      ...
      synchronized (FileServiceGrpc.class) {
        if ((getGetFileMethod = FileServiceGrpc.getGetFileMethod) == null) {
          FileServiceGrpc.getGetFileMethod = getGetFileMethod =
              io.grpc.MethodDescriptor.<com.zyc.protocol.User, com.zyc.protocol.FileOuterClass.File>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zyc.protocol.FileOuterClass.File.getDefaultInstance()))
  ...
  public static abstract class FileServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getFile(com.zyc.protocol.User request,
        io.grpc.stub.StreamObserver<com.zyc.protocol.FileOuterClass.File> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.zyc.protocol.FileOuterClass.File>(
  ...
  public static final class FileServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<FileServiceBlockingStub> {
    ...
    /**
     */
    public com.zyc.protocol.FileOuterClass.File getFile(com.zyc.protocol.User request) {
  ...
  public static final class FileServiceFutureStub extends io.grpc.stub.AbstractFutureStub<FileServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.zyc.protocol.FileOuterClass.File> getFile(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FILE:
          serviceImpl.getFile((com.zyc.protocol.User) request,
              (io.grpc.stub.StreamObserver<com.zyc.protocol.FileOuterClass.File>) responseObserver);
          break;
        default:
