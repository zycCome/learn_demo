...
//        EnvironmentVariableCredentialsProvider credentialsProvider = CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider();
        ...
        String objectName = "hz/11111.jpg";
        // 填写Object下载到本地的完整路径。
        String pathName = "/Users/zilu/Desktop/full1.jpg";
...
//生成的安全令牌SecurityToken。
        ...
        // 创建OSSClient实例。
        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId1,accessKeySecret1,securityToken1);
